...
void fct_void_remieu_script()
{
	...
	cout << "The cave seems to go deep down to the point you can't even see the outside light anymore as you feel a freezing cold breeze" << endl;

	system("pause");

	cout << "You feel a constant freezing cold breeze, and after some time walking, you notice you're slowly going up again and soon perceive a weak light while the temperature seems to continue dropping" << endl;

	system("pause");

	cout << "When you finally get out of the rabbit hole, it seems the night has already fallen and a blizzard arrived, you see a village near the exit and you rush to it" << endl;

	system("pause");

	cout << "Once in the village, you remark everything is in ruins, humans are standing frozen and corpses on the ground have a big hole in them" << endl;
...
void fct_void_after_cave_script()
{
	...
	cout << "\nAs the river entered the cave, you have no landmark to follow or anywhere to go, you feel like its been a long time since you passed the cave and start to lose hope" << endl;

	cout << "\nDo you want to try to come back?" << endl;
	cout << "[1] Yes" << endl;
	cout << "[2] No" << endl;
	...
	case 1: // If player chooses to try to come back: dies of Blizzard
		...
		cout << "As the night comes in a glimpse of an eye, the temperature around you falls drastically, a blizzard appears and the grass becomes frozen" << endl;

		system("pause");

		cout << "Before you even have time to notice, your legs froze as you were standing and realizing what seemed to happ-" << endl;
...
void fct_void_cave_script()
{
	...
	cout << "After some time walking, you arrive to a cave entrance" << endl;
...
void fct_void_river_script()
{
	...
	case 1: // If player approaches slimes: scripted encounter and fight with Slimes
		...
		cout << "But the green mass comes back faster!\n" << endl;
...
void fct_void_road_script()
{
	...
	case 1: // If player enters forest: scripted encounter and fight with Oni too strong for player at start of game
		...
		cout << "A strange figure can be seen from afar, but before you understand what it is, it approaches you quickly\n" << endl;

		obj_opponent = obj_oni;

		system("pause");

		cout << "The enormous creature tries to cut you with a sword, but you barely dodge!\n" << endl;
...
void fct_void_farm_script()
{
	...
	cout << "\nYou approach the farm slowly and see an old man on a chair" << endl;

	system("pause");

	// Displays choices of talking to old man in farm

	cout << "\nDo you want to talk to him?" << endl;
	cout << "[1] Yes" << endl;
	cout << "[2] No" << endl;
	...
	case 1: // If players chooses to talk to old man
		...
		cout << "\nAy young man, what's you doing in a place like this! Ya lost?" << endl;
		cout << "[1] Nod" << endl;
		cout << "[2] Deny" << endl;
		...
		if (int_old_man_answer_choice == 1) // If players tells old man he is lost
		{
			...
			cout << "The river right next my farm leads to a cave towards Remieu, the nearest village" << endl;

			system("pause");

			cout << "The road's a no go if ya want my opinion, strange rumors say the hazy forest it leads to is full of powerful and mysterious creatures" << endl;

			system("pause");

			cout << "See ya again soon ma guy!" << endl;
