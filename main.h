...
void fct_void_remieu_path_script()
{
...
void fct_void_remieu_house3_script()
{
...
void fct_void_remieu_house2_script()
{
	...
	int int_array_str_remieu_house2_read_book_choice_story_size = 1;
	str array_str_remieu_house2_read_book_choice_story[2] = {
	...
	int int_array_str_remieu_house2_read_book_page1_story_size = 1;
	str array_str_remieu_house2_read_book_page1_story[2] = {

		"xxx date: I bought this diary at a small shop in xxx city, it was pretty expensive for a simple farmer like me, but I've always wanted one to let a proof of my life. Anyway, today the vegetables should be good to be gathered, I plan to do it after I played with Laura as I promised her yesterday. Also, I have to remember I told Tom I'd go with him to deliver a sword to xxx city, I'll quickly pass by the grocery as I forgot to buy milk.",

		"Read page 2?\n[1] Yes\n[2] No"

	};

	int int_array_str_remieu_house2_read_book_page2_story_size = 3;
	str array_str_remieu_house2_read_book_page2_story[4] = {
	...
	fct_void_display_story(array_str_remieu_house2_read_book_choice_story, int_array_str_remieu_house2_read_book_choice_story_size);
	...
	case 1: // If player chooses to read the book
		...
		fct_void_display_story(array_str_remieu_house2_read_book_page1_story, int_array_str_remieu_house2_read_book_page1_story_size);
		...
		case 1: // If player chooses to read the second page of the book
			...
			fct_void_display_story(array_str_remieu_house2_read_book_page2_story, int_array_str_remieu_house2_read_book_page2_story_size);
...
void fct_void_remieu_house1_script()
{

	int int_take_coat_choice;

	int int_array_str_remieu_house1_take_coat_story_size = 2;
	str array_str_remieu_house1_take_coat_story[3] = {
	...
	fct_void_display_story(array_str_remieu_house1_take_coat_story, int_array_str_remieu_house1_take_coat_story_size);
	...
	default: // If player writes an invalid choice
		...
		fct_void_remieu_house1_script();

	}

}

void fct_void_remieu_center_script()
{

	int int_remieu_explore_choice; // Represents where player decides to go from Remieu

	int int_array_str_remieu_explore_story_size = 0;
	str array_str_remieu_story[1] = {

		"Do you choose to explore the houses, follow the path or go back to the farm?\n[1] House 1\n[2] House 2\n[3] House 3\n[4] Farm\n[5] Path"

	};

	fct_void_display_story(array_str_remieu_story,int_array_str_remieu_explore_story_size);

	cin >> int_remieu_explore_choice;

	switch (int_remieu_explore_choice)
	{
	...
	case 4: // If player chooses to go back to farm
		...
		cout << "You choose to go back to the farm to see the situation..." << endl;
...
void fct_void_remieu_script()
{
	...
	int int_array_str_remieu_story_size = 10;
	str array_str_remieu_story[11] = {
		...
		"When you finally get out of the rabbit hole, it seems the night has already fallen and a blizzard arrived, you see a village near the exit and you rush to it",
	...
	fct_void_display_story(array_str_remieu_story, int_array_str_remieu_story_size);
...
void fct_void_farm_script()
{
	...
	str array_str_old_man_explain_story[4] = {
		...
		"The river right next my farm leads to a cave towards Remieu, the nearest village",
