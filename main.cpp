...
void main()
{
	...
	do
	{
		...
		case 8: // if current place: Remieu center

			fct_void_remieu_center_script();

			break;

		case 9: // if current place: Remieu house 1

			fct_void_remieu_house1_script();

			break;

		case 10: // if current place: Remieu house 2

			fct_void_remieu_house2_script();

			break;

		case 11: // if current place: Remieu house 3

			fct_void_remieu_house3_script();

			break;

		case 12: // if current place: Farm_after_blizzard

			fct_void_farm_after_blizzard_script();

			break;

		case 13: // if current place: Remieu path

			fct_void_remieu_path_script();
